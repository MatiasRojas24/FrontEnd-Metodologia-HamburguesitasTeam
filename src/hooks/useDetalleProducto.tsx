...
import {
  createDetalleProductoHttp,
  deleteDetalleProductoHttp,
  filtrarDetalleProductosHttp,
  getDetalleProductoByIdHttp,
  getDetallesProductosByProductoIdHttp,
  getDetallesProductosHabilitadosHttp,
  toggleHabilitadoHttp,
  updateDetalleProductoHttp,
} from "../http/detalleProductoHttp";
...
export const useDetalleProducto = () => {
  const {
    ...
    setDetallesProductosHabilitados,
    añadirDetalleDeProducto,
    actualizarDetalleDeProducto,
    eliminarDetalleDeProducto,
  ...
  const getDetalleProductoById = async (
  ...
  const createDetalleProducto = async (
  ...
  const updateDetalleProducto = async (
  ...
  const enableUnableDetalleProducto = async (
  ...
  const deleteDetalleProducto = async (
    detalleProductoId: string
  ): Promise<void> => {
    try {
  ...
  const filtrarDetalleProducto = async (
    filtro: IFiltroDetalleProducto
  ): Promise<void> => {
    try {
